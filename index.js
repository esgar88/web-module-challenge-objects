...
*/
createMenuItem("Hamburger", "8", "dinner");
createMenuItem("Fish Taco", "9", "dinenr");
createMenuItem("Chicken nuggets", "6", "dinner");
...
function getLastReview(object, name, rating, feedback) {
